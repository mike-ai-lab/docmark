<!-- Top Header with Report Name (Left) and Date (Right) -->
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
  <span style="font-size: 18px; font-weight: bold;">Market Pricing Survey – Saudi Arabia</span>
  <span style="font-size: 18px;">Date: 2026-02-11</span>
</div>
...
## 13. Bathroom Window (Operable, Double Glazed)
...
| Specification | Unit | Price (SAR) | Notes |
|--------------|------|-------------|------|
| SS 316 – Ø50 mm – 1.5 mm | m.ط | 600 | Must specify grade 316 |

---

## 15. Roof Access Ladder with Hooks
...
| Item | Unit | Price (SAR) | Notes |
|-----|------|-------------|------|
| Granite steps – external | m.ط | 220 – 240 | Includes cutting, polishing, fixing |
